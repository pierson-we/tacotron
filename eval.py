...
sentences = [
  'in which the rights of all Libyans would be respected . After the revolution , he supported the birth of a new democracy',
  'Along with three of his colleagues , Chris was killed in the city he helped to save .',
  'That was our founding purpose . That is what our history shows . That is what Chris Stevens worked for throughout his life .',
  'Al Qaeda has been weakened and Osama bin Laden is no more . Nations have come together to lock down nuclear materials , '
]
